...
number2phrase_dic = {0: 'zero', 1: 'one', 2: 'two', 3: 'three', 4: 'four', 5: 'five', 6:'six', 7:'seven', 8:'eight', 9:'nine', 10:'ten',
 ...
 30:'thiry', 40: 'fourty', 50: 'fifty', 60: 'sixty', 70:'seventy', 80: 'eighty', 90: 'ninety', 100: 'hundred', }
...
#use .get() to access a value with a key
    ...
    ones_digit = entry_int % 10
    tens_digit = int(entry_int /10) * 10
    hundreds_digit = int(entry_int/10) * 100
...
new_dict = {200: 'two-hundred', 300:'three-hundred', 400:'four-hundred', 500:'five-hundred', 600:'six-hundred', 700:'seven-hundred', 800:'eight-hundred', 900: 'nine-hundred'}
number2phrase_dic.update(new_dict)
