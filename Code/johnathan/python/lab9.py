...
# print(beowolf_text)
# create a variable to hold the total count of the txrt file 
word_count = 0
#iterate over each line of the file and open in read mode 
for line in beowolf_text: 
    words = line.split(" ") #use split function to create a list of strings after splitting the given string by " ".
    word_count =+ len(words) # use len of words to count the words 
beowolf_file.close() #ensure to close the .txt file 

print("The number of words in the beowolf.txt file is: ", word_count)
