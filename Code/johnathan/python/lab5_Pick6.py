...
# ticket and the winning numbers determines the payoff. 
...
#     computer_num_list.append(n)

# user_num_list = []
# for i in range (0,6):
#     n = int(input('Please enter your six numbers one at a time: '))
#     user_num_list.append(n)


# print(f'The winning numbers are: {computer_num_list}')
# print(f'Your numbers were: {user_num_list}')

# comparison = 0
# for number in user_num_list:
#     if number in computer_num_list:
#         comparison += 1

# print ('You guessed' + '' + str(comparison) + '' + 'number(s) right.')
