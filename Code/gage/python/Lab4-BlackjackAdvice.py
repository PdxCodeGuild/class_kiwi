...
if user_hand_one not in blackjack_values:
    ...
    hand_value = blackjack_values[user_hand_one] + blackjack_values[user_hand_two] + blackjack_values[user_hand_three]
...
# Changes ACE value to 1 if the hand value exceeds 21
if hand_value > 21:
    blackjack_values["A"] = 1
    hand_value = blackjack_values[user_hand_one] + blackjack_values[user_hand_two] + blackjack_values[user_hand_three]
