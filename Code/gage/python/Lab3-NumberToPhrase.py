...
if tens == 1:
    print( f"The number {user_num} is {number_word_teens[ones].title()}")

else:
    print( f"The number {user_num} is {number_word_tens[tens].title()}{number_word_ones[ones].title()}")
'''
...
# Checks if user entered a 3-digit number
    ...
    if tens == 1:
        print( f"The number {user_num} is {number_word_hunds[hunds]} and {number_word_teens[ones].title()}")
    # Checks if user entered a digit between 101 and 109
    elif tens == 0 and ones != 0:
        print( f"The number {user_num} is {number_word_hunds[hunds]} and {number_word_ones[ones]}")
