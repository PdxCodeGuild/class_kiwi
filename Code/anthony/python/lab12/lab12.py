...
class ATM:
    ...
    def print_transactions_deposit(self, amount):
        return f"User deposited:${amount}."

    def print_transactions_withdraw(self, amount):
        return f"User withdrew: ${amount}."

    def print_transactions_deposit(self, amount):
        return f"User deposit: ${amount}."
...
while True:
    ...
    if command == 'balance':
        ...
        trans.append(atm.print_transactions_deposit(amount))
        ...
        if atm.check_withdrawal(amount):
            ...
            trans.append(atm.print_transactions_withdraw(amount))
